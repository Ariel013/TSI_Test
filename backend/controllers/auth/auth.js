/* The code is importing various modules and dependencies required for the functionality of the script. */
...
/* The `exports.register` function is a controller function that handles the registration of a new
user. It takes in the request (`req`), response (`res`), and next middleware (`next`) as parameters. */
...
/* The `exports.login` function is a controller function that handles the login functionality. It takes
in the request (`req`), response (`res`), and next middleware (`next`) as parameters. */
